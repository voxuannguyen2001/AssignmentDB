...
class CartContainProductModel extends Database
{
    ...
    {
        $sql = "INSERT INTO cart_contain_product(cart_id,the_user_id, product_id, shop_id, product_count, saleprice) VALUES($cart_id, $the_user_id, $product_id, $shop_id, $product_count, $saleprice)";
