...
-- table users_manage_shop
DROP TABLE IF exists users_manage_shop;
CREATE TABLE users_manage_shop (
users_id	int not null,
shop_id int not null
);

-- constraint pk users_manage_shop
ALTER TABLE users_manage_shop
ADD CONSTRAINT users_shop_pk
primary key (users_id, shop_id);
...
product_count  int,
saleprice integer,
primary key (cart_id, users_id, product_id, shop_id)
);
...
begin
	insert into users (usersname, pass, mobile, email, fullname, sex, dob, avatar, seller_flag, buyer_flag)
		values (usersname, pass, mobile, email, fullname, sex, dob, avatar, seller_flag, buyer_flag);
end//
delimiter ;

drop trigger if exists on_create_users;
delimiter //
create trigger on_create_users before insert on users
for each row
...
INSERT INTO order_detail(shipping_id, order_status, create_date, users_id, sname, saddress,sphone_number )  
...
-- cart of users 1
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (1,1,1,1,2,10000);
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (1,1,7,2,1,100000);
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (1,1,13,3,5,21000);

-- cart of users 3
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (3,3,2,1,4,10000);
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (3,3,8,2,1,50000);
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (3,3,14,3,2,20000);

-- cart of users 4
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (4,4,19,4,2,10000);
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (4,4,25,5,2,20000);

-- cart of users 5
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (5,5,20,4,2,30000);
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (5,5,26,5,2,40000);

-- cart of users 7
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (7,7,3,1,2,60000);
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (7,7,4,1,1,70000);

-- cart of users 8
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (8,8,15,3,3,80000);
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (8,8,16,3,4,100000);

-- cart of users 10
insert into cart_contain_product (cart_id, users_id, product_id, shop_id, product_count, saleprice) values (9,9,30,5,1,7000);

insert into users_manage_shop values (1,1);
insert into users_manage_shop values (2,2);
insert into users_manage_shop values (3,3);
insert into users_manage_shop values (4,4);
insert into users_manage_shop values (5,5);
...
insert into cart (users_id) values (3);
insert into cart (users_id) values (4);
insert into cart (users_id) values (5);
insert into cart (users_id) values (6);
insert into cart (users_id) values (7);
insert into cart (users_id) values (8);
insert into cart (users_id) values (9);
insert into cart (users_id) values (10);
insert into cart (users_id) values (11);
...
ALTER TABLE shop
ADD FOREIGN KEY (shop_owner_id) REFERENCES users(users_id);
...
ALTER TABLE cart_contain_product
ADD FOREIGN KEY (cart_id,users_id) REFERENCES cart(cart_id,users_id);
